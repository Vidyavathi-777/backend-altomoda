...
// verify webhook
function verifyWebhookSignature(base64Response, receivedXVerify, endpointPath = config.phonepe.payEndpointPath) {
  const expected = computeSignature(base64Response, endpointPath);
  try {
