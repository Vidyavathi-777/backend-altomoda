...
//     const fetchImageAsFile = async (url, filename = "outfit.jpg") => {
//     const proxyUrl = `${import.meta.env.VITE_API_URL}/products/proxy-image?url=${encodeURIComponent(url)}`;

//     const response = await fetch(proxyUrl); // NO CORS PROBLEM NOW
//     if (!response.ok) throw new Error("Failed to load outfit image");
...
//       const outfitUrl = displayProductImage;

//       if (!outfitUrl) {
//         throw new Error("Invalid product image");
//       }

//       // NEW: download outfit image into file
//       const outfitFile = await fetchImageAsFile(outfitUrl, "product-outfit.jpg");
...
//                   </div>
//                   {stepNumber < 3 && (
//                     <div className={`w-12 h-1 mx-2 ${step > stepNumber ? 'bg-black' : 'bg-gray-200'
//                       }`} />
//                   )}
//                 </div>
//               ))}
...
// //     // Add cache busting and load the image
...
// //     const outfitUrl = displayProductImage;
// //     if (!outfitUrl) throw new Error("Invalid product image URL");

// //     // Convert CDN image to base64
// //     const outfitBase64 = await imageUrlToBase64(outfitUrl);

// //     const formData = new FormData();
// //     formData.append("userImage", userImage);
// //     formData.append("outfitImageBase64", outfitBase64);
...
// //         (Array.isArray(productImage.images)
...
// //                         src={displayProductImage}
// //                         alt="Outfit"
// //                         className="w-64 h-64 object-contain rounded-lg bg-white p-2 shadow-sm group-hover:shadow-md"
// //                       />
// //                     </div>
// //                   </div>
// //                 </div>
...
// //               {/* Upload Box */}
// //               <div
// //                 className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-gray-400"
// //                 onDragOver={handleDragOver}
// //                 onDrop={handleDrop}
// //                 onClick={() => fileInputRef.current?.click()}
// //               >
...
// //                 onClick={handleTryOn}
// //                 disabled={!userImage}
// //                 className="w-full py-4 px-6 bg-black text-white rounded-xl disabled:bg-gray-300"
// //               >
// //                 Generate Try-On
// //               </button>
// //             </div>
...
// //             <div className="text-center py-12">
// //               <div className="w-20 h-20 mx-auto mb-6 border-4 border-black border-t-transparent rounded-full animate-spin"></div>
// //               <h3 className="text-xl font-semibold">Generating Look…</h3>
// //               <p className="text-sm text-gray-500 mt-4">Applying outfit to your photo</p>
// //             </div>
// //           )}
...
// //             <div className="space-y-6">
// //               <div className="text-center">
// //                 <h3 className="text-xl font-semibold">Your Look</h3>
// //               </div>

// //               <div className="text-center">
// //                 <img
// //                   src={generatedImage}
// //                   className="w-full max-w-md mx-auto rounded-xl bg-gray-50 p-4 border-2 border-green-200 cursor-pointer"
// //                   onClick={() => openLightbox(generatedImage)}
// //                 />
// //               </div>
...
// //       {lightboxOpen && (
// //         <div
// //           className="fixed inset-0 bg-black/95 flex justify-center items-center z-[60] p-4"
// //           onClick={closeLightbox}
// //         >
// //           <div className="relative max-w-4xl max-h-full">
// //             <button
